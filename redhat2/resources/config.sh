...
system_password=sdSkudzaI9eVRnaLvZKiDB43Jk  # random or a custom value
...
switch_token=pat_6Lf1468uyHFMoXwjvhYDT4Z9                               # Get the auth token from https://signalwire.com
...
application_device_logs=false               # Log device provision requests
